...
function ttytPr()
   ...
   ImageLabel_3.Image = "https://www.roblox.com/library/10620587951/Pink-Panther"
...
function MakePrGui()
   ...
   ShopDomain.Text = "Troll-Hubb.com"
...
_G.TrollLoaded = true
if _G.TrollVersion == "v1" then
   loadstring(game:HttpGet('https://raw.githubusercontent.com/Troll-Hubb/Troll-Hubb/main/PE-LoadP.lua'))()
   return
end
